...
define('text!templates/contacts.html',[],function () { return '<img src="<%= photo %>" alt="<%= name %>" />\n<h1><%= name %><span><%= type %></span></h1>\n<div> <%= address %></div>\n<button class="delete">Delete</button>\n<button class="edit">Edit</button>\n<dl>\n    <dt>Tel: <%= tel %></dt>\n    <dd>Email: <%= email %></dd>\n</dl>\n';});
...
define('text!templates/footer.html',[],function () { return '<script id="footerTemplate" type="text/template">\n    <%= name %>\n</script>\n';});
